...
#############################################################################
#
# g2pMappingMagnitudeGaussianMutation
#
#############################################################################
class g2pMappingMagnitudeGaussianMutation(g2pMappingGaussianMutation):
    """
...
def unit_test():
    ...
    mutator = g2pMappingMagnitudeGaussianMutation(provider = None, sigma = 0.1, 
